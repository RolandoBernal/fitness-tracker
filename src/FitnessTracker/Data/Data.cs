...
namespace FitnessTracker.Data
{
    ...
    public static class Data
    {
        ...
        private static void InitData()
        {
            ...
            {
                new Activity(Activity.ActivityType.Golf),
                ...
                new Activity(Activity.ActivityType.Soccer),
                ...
                new Activity(Activity.ActivityType.CrossFit)
            };

            var entries = new List<Entry>()
            {
                new Entry(1, 2016, 7, 8, Activity.ActivityType.Golf, 10.0),
                new Entry(2, 2016, 7, 9, Activity.ActivityType.Biking, 12.2),
                new Entry(3, 2016, 7, 10, Activity.ActivityType.Golf, 123.0),
                ...
                new Entry(10, 2016, 7, 16, Activity.ActivityType.Golf, 23.4)
            };
